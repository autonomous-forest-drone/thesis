...
\justifying\noindent
In simulation, the policy achieved an episode-level success rate of 94.00\% (sparse) and 84.00\% (dense), with a combined rate of 89.00\% and a per-obstacle success rate of 95.60\%. In real-world trials, episode-level success was 74.00\% (sparse) and 70.00\% (dense), yielding an overall sim-to-real transfer efficiency of 80.90\% at the episode level and 83.68\% per obstacle.
