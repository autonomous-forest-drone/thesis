...
Despite this, the remaining 19.10\% episode-level gap reflects residual reality-gap sources that domain randomisation did not fully bridge. These were not isolated experimentally; plausible candidates include aerodynamic differences, actuation latency in the PX4 command pipeline, and camera calibration differences between the simulated and physical sensor. Quantifying their individual contributions is left to future work. The per-obstacle transfer rate of 91.76\% being considerably higher than the episode-level rate of 80.90\% suggests that the gap is not primarily a perception failure but a control precision issue: the agent sees the obstacles correctly but occasionally mistimes the avoidance manoeuvre in the real world due to physical dynamics the simulation did not perfectly capture.
