...
\input{components/tables/table8_avoidance_methods.tex}
...
\input{components/tables/table9_sensors.tex}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/rl_loop.png}
...
\input{components/tables/table10_kabas_comparison.tex}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/sim_vs_real.png}
...
\input{components/tables/table11_related_work.tex}
